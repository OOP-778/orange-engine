...
public class BukkitAdapter {
    ...
    public BukkitAdapter(GsonBuilder builder) {
    ...
    private static class ItemStackAdapter implements JsonSerializer<ItemStack>, JsonDeserializer<ItemStack> {
        ...
        public ItemStack deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
            ...
            return JsonItemStackHelper.fromJson(jsonElement.getAsJsonObject());
        }

        @Override
        public JsonElement serialize(ItemStack itemStack, Type type, JsonSerializationContext jsonSerializationContext) {
            return JsonItemStackHelper.toJson(itemStack);
        }
    }

    // Json ItemStack helper
    private static class JsonItemStackHelper {
