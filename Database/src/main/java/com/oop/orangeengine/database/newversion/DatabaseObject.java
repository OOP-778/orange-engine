...
import com.oop.orangeengine.database.newversion.suppliers.FieldGatherer;
import com.oop.orangeengine.database.newversion.suppliers.Suppliable;
...
public abstract class DatabaseObject implements Suppliable {
    ...
    public void unload(boolean async) {
        if (holder != null) {
            ...
            new OTask()
                    .sync(!async)
                    .runnable(() -> holder.deleteObject(this))
                    .execute();
        }
    }
