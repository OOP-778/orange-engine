...
public final class ReflectionUtils {
    ...
    public static Method method(Class<?> clazz, String methodName, Class<?>... parameterTypes) throws Exception {
        ...
        throw new IllegalAccessException("There is no such method in this class with the specified displayName and parameter types");
    }

    public static Method method(String className, Package packageType, String methodName, Class<?>... parameterTypes) throws Exception {
        return method(packageType.getClass(className), methodName, parameterTypes);
    }

    public static Object invokeMethod(Object instance, String methodName, Object... arguments) throws Exception {
        return method(instance.getClass(), methodName, Data.getPrimitive(arguments)).invoke(instance, arguments);
    }

    public static Object invokeMethod(Object instance, Class<?> clazz, String methodName, Object... arguments) throws Exception {
        return method(clazz, methodName, Data.getPrimitive(arguments)).invoke(instance, arguments);
    }
    ...
    public static Field field(Class<?> clazz, boolean declared, String fieldName) throws Exception {
    ...
    public static Field field(String className, Package packageType, boolean declared, String fieldName) throws Exception {
        return field(packageType.getClass(className), declared, fieldName);
    }


    public static void setValue(Object instance, Class<?> clazz, boolean declared, String fieldName, Object value) throws Exception {
        field(clazz, declared, fieldName).set(instance, value);
    }
